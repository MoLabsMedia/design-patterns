// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/09/java-reflection-video-tutorial/
// --------------
...
// The Java Reflection API is used to manipulate classes and everything in a class including fields, methods, constructors, private data, etc. Because using the Reflection API is most often Dynamic it can slow down a program because the JVM can't optimize the code. The Reflection API can't be used with applets because of the added security applets require. Because this API allows you to do things like access private fields, methods, etc. it should be used sparingly, or else potentially destroy the logic of a program
...
public class TestingReflection {
  public static void main(String[] args){
    // Getting the class Object for UFOEnemyShip Everything in Java has a Class Object
    Class reflectClass = UFOEnemyShip.class;
    // Get the class name of an Object
    String className = reflectClass.getName();
    System.out.println(className + "\n");
    // Check modifiers of a class isAbstract, isFinal, isInterface, isPrivate, isProtected, isStatic, isStrict, isSynchronized, isVolatile
    int classModifiers = reflectClass.getModifiers();
    System.out.println(Modifier.isPublic(classModifiers) + "\n");
    // You can get a list of interfaces used by a class Class[] interfaces = reflectClass.getInterfaces(); Get the super class for UFOEnemyShip
    ...
    try {
      // If you know the parameters of the constructor you want you do the following. To return an array of constructors instead do this Constructor[] constructors = reflectClass.getConstructors(); If the constructor receives a String you'd use the parameter new Class[]{String.class} For others use int.class, double.class, etc.
    ...
    // Access private fields using reflection Field stores info on a single field of a class
    Field privateStringName = null;
    try {
      // Create a UFOEnemyShip object
      UFOEnemyShip enemyshipPrivate = new UFOEnemyShip(shipFactory);
      // Define the private field you want to access I can access any field with just its name dynamically
      ...
      // Get access to a private method getDeclaredMethod("methodName", methodParamters or null) Since I provide the method name as a String I can run any method without needing to follow the normal convention methodName()
      ...
      // Execute a method that has parameters Define the parameters expected by the private method
