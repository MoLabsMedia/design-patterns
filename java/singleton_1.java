// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/09/singleton-design-pattern-tutorial/
// --------------
...
public class Singleton {
  ...
  public LinkedList<String> getTiles(int howManyTiles){
    ...
    // Cycle through the LinkedList while adding the starting Strings to the to be returned LinkedList while deleting them from letterList
...
public class ScrabbleTest {
  public static void main(String[] args){
    ...
    System.out.println(newInstance.getLetterList());
    // Try to make another instance of Singleton This doesn't work because the constructor is private Singleton instanceTwo = new Singleton(); Try getting a new instance using getInstance
...
public class ScrabbleTestThreads{
  public static void main(String[] args){
    // Create a new Thread created using the Runnable interface Execute the code in run after 10 seconds
