...
// -------------- ANIMAL.JAVA -------------- //
// By making this class cloneable you are telling Java that it is ok to copy instances of this class These instance copies have different results when System.identityHashCode(System.identityHashCode(bike)) is called
...
public class CloneFactory {
  // Receives any Animal, or Animal subclass and makes a copy of it and stores it in its own location in memory CloneFactory has no idea what these objects are except that they are subclasses of Animal
