// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/10/iterator-design-pattern-tutorial/
// --------------

// -------------- SONGINFO.JAVA -------------- //
// Will hold all of the info needed for each song I told all users to: 1. create a function named addSong() for adding song, band and release 2. create a function named getBestSongs() that will return the collection
//    of songs
...
public class SongsOfThe70s implements SongIterator{
  ...
  // Get rid of this Return the ArrayList filled with SongInfo Objects
...
public class SongsOfThe90s implements SongIterator{
  ...
  // This is replaced by the Iterator Return a Hashtable full of SongInfo Objects
...
public class DiscJockey {
  ...
  */
  ...
  public void showTheSongs(){
    // Because the SongInfo Objects are stored in different collections everything must be handled on an individual basis. This is BAD!
