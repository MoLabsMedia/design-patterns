...
// -------------- ENEMYATTACKER.JAVA -------------- //
// This is the Target Interface : This is what the client expects to work with. It is the adapters job to make new classes compatible with this one.
...
// -------------- ENEMYTANK.JAVA -------------- //
// EnemyTank implements EnemyAttacker perfectly Our job is to make classes with different methods from EnemyAttacker to work with the EnemyAttacker interface
