// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/09/factory-design-pattern-tutorial/
// --------------
...
public class EnemyShipTesting {
  public static void main(String[] args){
    ...
    System.out.print("\n");
    // -----------------------------------------
    // This allows me to make the program more dynamic It doesn't close the code from being modified and that is bad! Defines an input stream to watch: keyboard
    Scanner userInput = new Scanner(System.in);
...
// This is a factory thats only job is creating ships By encapsulating ship creation, we only have one place to make modifications
