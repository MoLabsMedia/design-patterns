// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/10/memento-design-pattern-tutorial/
// --------------

// -------------- MEMENTO.JAVA -------------- //
// Memento Design Pattern Used stores an objects state at a point in time so it can be returned to that state later. It simply allows you to undo/redo changes on an Object
...
public class TestMemento extends JFrame{
   ...
   // ---------------------------------------------
   // Create a caretaker that contains the ArrayList with all the articles in it. It can add and retrieve articles from the ArrayList
   Caretaker caretaker = new Caretaker();
   // The originator sets the value for the article, creates a new memento with a new article, and gets the article stored in the current memento
   ...
   class ButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      if(e.getSource() == saveBut){
        ...
        // saveFiles monitors how many articles are saved currentArticle monitors the current article displayed
        saveFiles++;
        currentArticle++;
