// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/08/observer-design-pattern-tutorial/
// --------------
...
public class GrabStocks{
  public static void main(String[] args){
    ...
    stockGrabber.setAAPLPrice(677.60);
    stockGrabber.setGOOGPrice(676.40);
    // Delete one of the observers stockGrabber.unregister(observer2);
    stockGrabber.setIBMPrice(197.00);
    stockGrabber.setAAPLPrice(677.60);
    stockGrabber.setGOOGPrice(676.40);
    // Create 3 threads using the Runnable interface GetTheStock implements Runnable, so it doesn't waste its one extendable class option
