// --------------
// CREDIT: Derek Banas
// URL: http://www.newthinktank.com/2012/10/template-method-design-pattern-tutorial/
// --------------
...
public abstract class Hoagie {
  ...
  // This is the Template Method Declare this method final to keep subclasses from changing the algorithm
  ...
  // These are called hooks If the user wants to override these they can Use abstract methods when you want to force the user to override and use a hook when you want it to be optional
