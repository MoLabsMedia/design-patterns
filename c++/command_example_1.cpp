...
// URL: https://sourcemaking.com/design_patterns/command/cpp/1
// --------------

// Before: the client has to query the "type" of each object, and manually invoke the desired method.
class Giant
{
  public:
    enum Type
...
// After: the desired method is encapsulated in each Command object.
class Giant
{
  public:
    Giant()
